...
// tests for ListBookingCustomAttributeDefinitionsResponse
void main() {
  // final instance = ListBookingCustomAttributeDefinitionsResponse();

  group('test ListBookingCustomAttributeDefinitionsResponse', () {
