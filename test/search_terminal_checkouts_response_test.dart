...
// tests for SearchTerminalCheckoutsResponse
void main() {
  // final instance = SearchTerminalCheckoutsResponse();

  group('test SearchTerminalCheckoutsResponse', () {
    ...
    // List<TerminalCheckout> checkouts (default value: const [])
    test('to test the property `checkouts`', () async {
      // TODO
    });
