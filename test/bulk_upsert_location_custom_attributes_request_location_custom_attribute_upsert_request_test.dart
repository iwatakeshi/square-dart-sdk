...
// tests for BulkUpsertLocationCustomAttributesRequestLocationCustomAttributeUpsertRequest
void main() {
  // final instance = BulkUpsertLocationCustomAttributesRequestLocationCustomAttributeUpsertRequest();

  group(
      'test BulkUpsertLocationCustomAttributesRequestLocationCustomAttributeUpsertRequest',
      () {
