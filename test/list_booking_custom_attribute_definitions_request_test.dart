...
// tests for ListBookingCustomAttributeDefinitionsRequest
void main() {
  // final instance = ListBookingCustomAttributeDefinitionsRequest();

  group('test ListBookingCustomAttributeDefinitionsRequest', () {
