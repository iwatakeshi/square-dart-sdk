...
// tests for BulkUpsertMerchantCustomAttributesRequest
void main() {
  // final instance = BulkUpsertMerchantCustomAttributesRequest();

  group('test BulkUpsertMerchantCustomAttributesRequest', () {
    ...
    // Map<String, MerchantCustomAttributeUpsertRequest> values (default value: const {})
