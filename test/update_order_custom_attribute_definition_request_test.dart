...
// tests for UpdateOrderCustomAttributeDefinitionRequest
void main() {
  // final instance = UpdateOrderCustomAttributeDefinitionRequest();

  group('test UpdateOrderCustomAttributeDefinitionRequest', () {
