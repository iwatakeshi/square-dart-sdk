...
// tests for SearchLoyaltyAccountsResponse
void main() {
  // final instance = SearchLoyaltyAccountsResponse();

  group('test SearchLoyaltyAccountsResponse', () {
    ...
    // List<LoyaltyAccount> loyaltyAccounts (default value: const [])
    test('to test the property `loyaltyAccounts`', () async {
      // TODO
    });
