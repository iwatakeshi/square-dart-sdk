...
// tests for ListLocationCustomAttributeDefinitionsResponse
void main() {
  // final instance = ListLocationCustomAttributeDefinitionsResponse();

  group('test ListLocationCustomAttributeDefinitionsResponse', () {
