...
// tests for ListDeviceCodesResponse
void main() {
  // final instance = ListDeviceCodesResponse();

  group('test ListDeviceCodesResponse', () {
    ...
    // List<DeviceCode> deviceCodes (default value: const [])
    test('to test the property `deviceCodes`', () async {
      // TODO
    });
