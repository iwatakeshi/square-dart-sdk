...
// tests for BulkUpsertMerchantCustomAttributesRequestMerchantCustomAttributeUpsertRequest
void main() {
  // final instance = BulkUpsertMerchantCustomAttributesRequestMerchantCustomAttributeUpsertRequest();

  group(
      'test BulkUpsertMerchantCustomAttributesRequestMerchantCustomAttributeUpsertRequest',
      () {
