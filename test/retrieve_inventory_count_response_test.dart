...
// tests for RetrieveInventoryCountResponse
void main() {
  // final instance = RetrieveInventoryCountResponse();

  group('test RetrieveInventoryCountResponse', () {
    ...
    // List<InventoryCount> counts (default value: const [])
