...
// tests for ListDisputesResponse
void main() {
  // final instance = ListDisputesResponse();

  group('test ListDisputesResponse', () {
    ...
    // List<Dispute> disputes (default value: const [])
    test('to test the property `disputes`', () async {
      // TODO
    });
