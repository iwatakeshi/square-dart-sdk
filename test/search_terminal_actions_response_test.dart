...
// tests for SearchTerminalActionsResponse
void main() {
  // final instance = SearchTerminalActionsResponse();

  group('test SearchTerminalActionsResponse', () {
    ...
    // List<TerminalAction> action (default value: const [])
