...
// tests for RetrieveCustomerCustomAttributeDefinitionRequest
void main() {
  // final instance = RetrieveCustomerCustomAttributeDefinitionRequest();

  group('test RetrieveCustomerCustomAttributeDefinitionRequest', () {
