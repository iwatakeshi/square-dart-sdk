...
// tests for ListMerchantCustomAttributeDefinitionsRequest
void main() {
  // final instance = ListMerchantCustomAttributeDefinitionsRequest();

  group('test ListMerchantCustomAttributeDefinitionsRequest', () {
    // Filters the `CustomAttributeDefinition` results by their `visibility` values.
    // String visibilityFilter
    test('to test the property `visibilityFilter`', () async {
      // TODO
    });
