...
// tests for BulkUpsertLocationCustomAttributesResponse
void main() {
  // final instance = BulkUpsertLocationCustomAttributesResponse();

  group('test BulkUpsertLocationCustomAttributesResponse', () {
    ...
    // Map<String, LocationCustomAttributeUpsertResponse> values (default value: const {})
