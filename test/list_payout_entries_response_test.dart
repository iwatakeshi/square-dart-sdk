...
// tests for ListPayoutEntriesResponse
void main() {
  // final instance = ListPayoutEntriesResponse();

  group('test ListPayoutEntriesResponse', () {
    // The requested list of payout entries, ordered with the given or default sort order.
    // List<PayoutEntry> payoutEntries (default value: const [])
    test('to test the property `payoutEntries`', () async {
      // TODO
    });
