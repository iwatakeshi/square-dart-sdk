...
// tests for BulkUpdateVendorsResponse
void main() {
  // final instance = BulkUpdateVendorsResponse();

  group('test BulkUpdateVendorsResponse', () {
    ...
    // Map<String, UpdateVendorResponse> responses (default value: const {})
