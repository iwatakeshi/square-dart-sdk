...
// tests for BulkUpsertBookingCustomAttributesRequest
void main() {
  // final instance = BulkUpsertBookingCustomAttributesRequest();

  group('test BulkUpsertBookingCustomAttributesRequest', () {
    ...
    // Map<String, BookingCustomAttributeUpsertRequest> values (default value: const {})
