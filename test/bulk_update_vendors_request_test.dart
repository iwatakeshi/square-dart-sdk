...
// tests for BulkUpdateVendorsRequest
void main() {
  // final instance = BulkUpdateVendorsRequest();

  group('test BulkUpdateVendorsRequest', () {
    ...
    // Map<String, UpdateVendorRequest> vendors (default value: const {})
    test('to test the property `vendors`', () async {
      // TODO
    });
  });
}
