...
// tests for CreateOrderCustomAttributeDefinitionRequest
void main() {
  // final instance = CreateOrderCustomAttributeDefinitionRequest();

  group('test CreateOrderCustomAttributeDefinitionRequest', () {
