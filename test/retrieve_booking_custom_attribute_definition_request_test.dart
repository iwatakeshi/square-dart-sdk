...
// tests for RetrieveBookingCustomAttributeDefinitionRequest
void main() {
  // final instance = RetrieveBookingCustomAttributeDefinitionRequest();

  group('test RetrieveBookingCustomAttributeDefinitionRequest', () {
