...
// tests for BulkDeleteBookingCustomAttributesRequest
void main() {
  // final instance = BulkDeleteBookingCustomAttributesRequest();

  group('test BulkDeleteBookingCustomAttributesRequest', () {
    ...
    // Map<String, BookingCustomAttributeDeleteRequest> values (default value: const {})
