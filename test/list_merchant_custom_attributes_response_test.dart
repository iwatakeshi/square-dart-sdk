...
// tests for ListMerchantCustomAttributesResponse
void main() {
  // final instance = ListMerchantCustomAttributesResponse();

  group('test ListMerchantCustomAttributesResponse', () {
    ...
    // List<CustomAttribute> customAttributes (default value: const [])
