...
// tests for ListLoyaltyPromotionsResponse
void main() {
  // final instance = ListLoyaltyPromotionsResponse();

  group('test ListLoyaltyPromotionsResponse', () {
    ...
    // List<LoyaltyPromotion> loyaltyPromotions (default value: const [])
    test('to test the property `loyaltyPromotions`', () async {
      // TODO
    });
