...
// tests for CatalogInfoResponse
void main() {
  // final instance = CatalogInfoResponse();

  group('test CatalogInfoResponse', () {
    ...
    test('to test the property `standardUnitDescriptionGroup`', () async {
      // TODO
    });
  });
}
