...
// tests for RetrieveMerchantCustomAttributeRequest
void main() {
  // final instance = RetrieveMerchantCustomAttributeRequest();

  group('test RetrieveMerchantCustomAttributeRequest', () {
