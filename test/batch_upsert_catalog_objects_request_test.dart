...
// tests for BatchUpsertCatalogObjectsRequest
void main() {
  // final instance = BatchUpsertCatalogObjectsRequest();

  group('test BatchUpsertCatalogObjectsRequest', () {
    ...
    // List<CatalogObjectBatch> batches (default value: const [])
