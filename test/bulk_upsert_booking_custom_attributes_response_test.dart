...
// tests for BulkUpsertBookingCustomAttributesResponse
void main() {
  // final instance = BulkUpsertBookingCustomAttributesResponse();

  group('test BulkUpsertBookingCustomAttributesResponse', () {
    ...
    // Map<String, BookingCustomAttributeUpsertResponse> values (default value: const {})
