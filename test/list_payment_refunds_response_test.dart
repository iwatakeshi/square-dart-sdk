...
// tests for ListPaymentRefundsResponse
void main() {
  // final instance = ListPaymentRefundsResponse();

  group('test ListPaymentRefundsResponse', () {
    ...
    // List<PaymentRefund> refunds (default value: const [])
