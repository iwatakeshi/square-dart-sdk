...
// tests for BulkDeleteOrderCustomAttributesResponse
void main() {
  // final instance = BulkDeleteOrderCustomAttributesResponse();

  group('test BulkDeleteOrderCustomAttributesResponse', () {
    ...
    // Map<String, DeleteOrderCustomAttributeResponse> values (default value: const {})
