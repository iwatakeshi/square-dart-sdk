...
void main() {
  var instance = new MerchantCustomAttributesApi();
  ...
  group('tests for MerchantCustomAttributesApi', () {
    ...
    //
    //Future<UpdateMerchantCustomAttributeDefinitionResponse> updateMerchantCustomAttributeDefinition(UpdateMerchantCustomAttributeDefinitionRequest body, String key) async
    ...
    //
    //Future<UpsertMerchantCustomAttributeResponse> upsertMerchantCustomAttribute(UpsertMerchantCustomAttributeRequest body, String merchantId, String key) async
