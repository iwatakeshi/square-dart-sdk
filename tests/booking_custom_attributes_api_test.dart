...
void main() {
  var instance = new BookingCustomAttributesApi();
  ...
  group('tests for BookingCustomAttributesApi', () {
    ...
    //
    //Future<UpdateBookingCustomAttributeDefinitionResponse> updateBookingCustomAttributeDefinition(UpdateBookingCustomAttributeDefinitionRequest body, String key) async
    ...
    //
    //Future<UpsertBookingCustomAttributeResponse> upsertBookingCustomAttribute(UpsertBookingCustomAttributeRequest body, String bookingId, String key) async
