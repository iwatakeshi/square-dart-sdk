...
void main() {
  var instance = new OrderCustomAttributesApi();
  ...
  group('tests for OrderCustomAttributesApi', () {
    ...
    //
    //Future<UpdateOrderCustomAttributeDefinitionResponse> updateOrderCustomAttributeDefinition(UpdateOrderCustomAttributeDefinitionRequest body, String key) async
    ...
    //
    //Future<UpsertOrderCustomAttributeResponse> upsertOrderCustomAttribute(UpsertOrderCustomAttributeRequest body, String orderId, String customAttributeKey) async
