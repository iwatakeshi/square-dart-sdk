...
void main() {
  var instance = new V1TransactionsApi();
  ...
  group('tests for V1TransactionsApi', () {
    ...
    //
    //Future<V1Refund> v1CreateRefund(V1CreateRefundRequest body, String locationId) async
    ...
    //
    //Future<V1Order> v1UpdateOrder(V1UpdateOrderRequest body, String locationId, String orderId) async
