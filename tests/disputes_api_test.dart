...
void main() {
  ...
  group('tests for DisputesApi', () {
    ...
    //
    //Future<CreateDisputeEvidenceTextResponse> createDisputeEvidenceText(CreateDisputeEvidenceTextRequest body, String disputeId) async
