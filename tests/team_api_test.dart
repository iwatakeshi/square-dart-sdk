...
void main() {
  ...
  group('tests for TeamApi', () {
    ...
    //
    //Future<UpdateTeamMemberResponse> updateTeamMember(UpdateTeamMemberRequest body, String teamMemberId) async
    ...
    //
    //Future<UpdateWageSettingResponse> updateWageSetting(UpdateWageSettingRequest body, String teamMemberId) async
