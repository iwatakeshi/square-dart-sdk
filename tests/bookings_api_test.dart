...
void main() {
  ...
  group('tests for BookingsApi', () {
    ...
    //
    //Future<CancelBookingResponse> cancelBooking(CancelBookingRequest body, String bookingId) async
    ...
    //
    //Future<UpdateBookingResponse> updateBooking(UpdateBookingRequest body, String bookingId) async
