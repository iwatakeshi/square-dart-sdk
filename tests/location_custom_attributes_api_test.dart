...
void main() {
  var instance = new LocationCustomAttributesApi();
  ...
  group('tests for LocationCustomAttributesApi', () {
    ...
    //
    //Future<UpdateLocationCustomAttributeDefinitionResponse> updateLocationCustomAttributeDefinition(UpdateLocationCustomAttributeDefinitionRequest body, String key) async
    ...
    //
    //Future<UpsertLocationCustomAttributeResponse> upsertLocationCustomAttribute(UpsertLocationCustomAttributeRequest body, String locationId, String key) async
