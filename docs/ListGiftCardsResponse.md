# swagger.model.ListGiftCardsResponse
...
**giftCards** | [**List&lt;GiftCard&gt;**](GiftCard.md) | The requested gift cards or an empty object if none are found. | [optional] [default to []]
