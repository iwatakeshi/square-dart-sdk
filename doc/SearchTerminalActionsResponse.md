# openapi.model.SearchTerminalActionsResponse
...
**action** | [**List<TerminalAction>**](TerminalAction.md) | The requested search result of `TerminalAction`s. | [optional] [default to const []]
