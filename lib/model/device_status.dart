...
class DeviceStatus {
  ...
  @override
  String toString() => 'DeviceStatus[category=$category]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "DeviceStatus[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "DeviceStatus[$key]" has a null value in JSON.');
        });
        return true;
      }());
