...
class GiftCardActivityActivate {
  /// Returns a new [GiftCardActivityActivate] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GiftCardActivityActivate &&
  ...
  @override
  String toString() => 'GiftCardActivityActivate[amountMoney=$amountMoney, orderId=$orderId, lineItemUid=$lineItemUid, referenceId=$referenceId, buyerPaymentInstrumentIds=$buyerPaymentInstrumentIds]';
  ...
  /// Returns a new [GiftCardActivityActivate] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GiftCardActivityActivate? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "GiftCardActivityActivate[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "GiftCardActivityActivate[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<GiftCardActivityActivate> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <GiftCardActivityActivate>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GiftCardActivityActivate.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, GiftCardActivityActivate> mapFromJson(dynamic json) {
    final map = <String, GiftCardActivityActivate>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GiftCardActivityActivate.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of GiftCardActivityActivate-objects as value to a dart map
  static Map<String, List<GiftCardActivityActivate>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<GiftCardActivityActivate>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = GiftCardActivityActivate.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
