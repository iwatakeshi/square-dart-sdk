...
class Fulfillment {
  ...
  List<FulfillmentFulfillmentEntry> entries;
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  FulfillmentPickupDetails? pickupDetails;
  ...
  @override
  String toString() => 'Fulfillment[uid=$uid, type=$type, state=$state, lineItemApplication=$lineItemApplication, entries=$entries, metadata=$metadata, pickupDetails=$pickupDetails, shipmentDetails=$shipmentDetails, deliveryDetails=$deliveryDetails]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "Fulfillment[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "Fulfillment[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return Fulfillment(
        ...
        entries: FulfillmentFulfillmentEntry.listFromJson(json[r'entries']),
        metadata: mapCastOfType<String, String>(json, r'metadata') ?? const {},
        pickupDetails: FulfillmentPickupDetails.fromJson(json[r'pickup_details']),
        shipmentDetails: FulfillmentShipmentDetails.fromJson(json[r'shipment_details']),
        deliveryDetails: FulfillmentDeliveryDetails.fromJson(json[r'delivery_details']),
      );
    }
    return null;
  }
