...
class FulfillmentShipmentDetails {
  /// Returns a new [FulfillmentShipmentDetails] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FulfillmentShipmentDetails &&
  ...
  /// Returns a new [FulfillmentShipmentDetails] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static FulfillmentShipmentDetails? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FulfillmentShipmentDetails[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FulfillmentShipmentDetails[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<FulfillmentShipmentDetails> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <FulfillmentShipmentDetails>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FulfillmentShipmentDetails.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, FulfillmentShipmentDetails> mapFromJson(dynamic json) {
    final map = <String, FulfillmentShipmentDetails>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = FulfillmentShipmentDetails.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of FulfillmentShipmentDetails-objects as value to a dart map
  static Map<String, List<FulfillmentShipmentDetails>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<FulfillmentShipmentDetails>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = FulfillmentShipmentDetails.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
