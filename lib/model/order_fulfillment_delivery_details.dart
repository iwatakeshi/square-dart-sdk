...
class OrderFulfillmentDeliveryDetails {
  /// Returns a new [OrderFulfillmentDeliveryDetails] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is OrderFulfillmentDeliveryDetails &&
  ...
  /// Returns a new [OrderFulfillmentDeliveryDetails] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static OrderFulfillmentDeliveryDetails? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "OrderFulfillmentDeliveryDetails[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "OrderFulfillmentDeliveryDetails[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return OrderFulfillmentDeliveryDetails(
  ...
  static List<OrderFulfillmentDeliveryDetails> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <OrderFulfillmentDeliveryDetails>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = OrderFulfillmentDeliveryDetails.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, OrderFulfillmentDeliveryDetails> mapFromJson(dynamic json) {
    final map = <String, OrderFulfillmentDeliveryDetails>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = OrderFulfillmentDeliveryDetails.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of OrderFulfillmentDeliveryDetails-objects as value to a dart map
  static Map<String, List<OrderFulfillmentDeliveryDetails>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<OrderFulfillmentDeliveryDetails>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = OrderFulfillmentDeliveryDetails.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
