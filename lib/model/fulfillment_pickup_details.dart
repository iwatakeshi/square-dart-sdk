...
class FulfillmentPickupDetails {
  /// Returns a new [FulfillmentPickupDetails] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is FulfillmentPickupDetails &&
  ...
  /// Returns a new [FulfillmentPickupDetails] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static FulfillmentPickupDetails? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "FulfillmentPickupDetails[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "FulfillmentPickupDetails[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return FulfillmentPickupDetails(
        ...
        curbsidePickupDetails: FulfillmentPickupDetailsCurbsidePickupDetails.fromJson(json[r'curbside_pickup_details']),
      );
    }
    return null;
  }

  static List<FulfillmentPickupDetails> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <FulfillmentPickupDetails>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = FulfillmentPickupDetails.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, FulfillmentPickupDetails> mapFromJson(dynamic json) {
    final map = <String, FulfillmentPickupDetails>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = FulfillmentPickupDetails.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of FulfillmentPickupDetails-objects as value to a dart map
  static Map<String, List<FulfillmentPickupDetails>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<FulfillmentPickupDetails>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = FulfillmentPickupDetails.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
