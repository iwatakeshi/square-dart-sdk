...
class LocationType {
  ...
  static const PHYSICAL = LocationType._(r'PHYSICAL');
  static const MOBILE = LocationType._(r'MOBILE');
...
class LocationTypeTypeTransformer {
  ...
  LocationType? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'PHYSICAL': return LocationType.PHYSICAL;
        case r'MOBILE': return LocationType.MOBILE;
        default:
          if (!allowNull) {
