...
class ListTransactionsRequest {
  /// Returns a new [ListTransactionsRequest] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ListTransactionsRequest &&
  ...
  @override
  String toString() => 'ListTransactionsRequest[beginTime=$beginTime, endTime=$endTime, sortOrder=$sortOrder, cursor=$cursor]';
  ...
  /// Returns a new [ListTransactionsRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ListTransactionsRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ListTransactionsRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ListTransactionsRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ListTransactionsRequest> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ListTransactionsRequest>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ListTransactionsRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ListTransactionsRequest> mapFromJson(dynamic json) {
    final map = <String, ListTransactionsRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ListTransactionsRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ListTransactionsRequest-objects as value to a dart map
  static Map<String, List<ListTransactionsRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ListTransactionsRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ListTransactionsRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
